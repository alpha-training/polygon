...
bbsimplestrat:{[tr;Tsym]
    ...
    (`Sharpe_Ratio`Portfolio_Return`standard_dev`max_drawdown)!(first raze sharpe_ratio;-1+first raze stratacc_return;first sdev pr;min strat1`dd) /show acc return and sharpe ratio and max dd
  }
